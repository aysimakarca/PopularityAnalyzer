# YouTube weekly popularity distributions

Metric: `youtube_exact_video_view_count` (exact recommended-video view count).
...
YouTube popularity is the cumulative view count of the exact recommended video; video type is retained because recommendations can be Art Tracks or official music videos.
